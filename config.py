...
SEQUENCE_OR_IMAGE_NAME = "pig_data:/media/scau2311/A/xcg/SMALify/data/PIG_DATA/smalify_pig/pig_10698.jpg"
...
CHECKPOINT_NAME = "20230802" # the directory to run
...
PIG_MODEL_JOINTS = [
  ...
  35, 36, # nose, chin
  37, 38, # ear tip [left, right]
  39, 40,# eyes [left, right]
  28, 41] #tail mid, throat

PIG_MODEL_JOINTS_NAME = [
  "l_paw0", "l_mid1", "l_top2",
  "l_paw3", "l_mid4", "l_top5",
  "r_paw6", "r_mid7", "r_top8",
  "r_paw9", "r_mid10", "r_top11",
  "t_12", "t_13",
  "l_ear14", "r_ear15",
  "nose16", "chin17",
  "l_ear_t18", "r_ear_t19",
...
MARKER_COLORS = [
    ...
    [60, 180, 75], [60, 180, 75], [60, 180, 75], # upper_right, green
    [0, 130, 200], [0, 130, 200], [0, 130, 200], # lower_right, blue
    [240, 50, 230], [240, 50, 230], [240, 50, 230], # tail, majenta
    [255, 153, 204], [29, 98, 115], # left_ear, pink & right_ear, turquoise
    [245, 130, 48], [245, 130, 48], # nose, chin
    [255, 153, 204], [29, 98, 115], # left_ear, pink & right_tip, turquoise
    [0, 0, 0], [0, 0, 0], # right eye, left eye: black
    [128, 0, 0], [128, 0, 0], # tail mid, throat
    ]
